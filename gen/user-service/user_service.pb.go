...
type UserProfileResponse struct {
	...
	Role          Roles                  `protobuf:"varint,6,opt,name=role,proto3,enum=user_profile.Roles" json:"role,omitempty"` // Роль пользователя
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UserProfileResponse) GetRole() Roles {
	if x != nil {
		return x.Role
	}
...
const file_user_service_user_service_proto_rawDesc = "" +
	"\n" +
	"\x1fuser-service/user_service.proto\x12\fuser_profile\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/api/annotations.proto\"\x93\x01\n" +
	...
	"\x04role\x18\x06 \x01(\x0e2\x13.user_profile.RolesR\x04role\"K\n" +
	...
	"\x05ADMIN\x10\x022\xb9\x05\n" +
	"\vUserService\x12b\n" +
	"\bRegister\x12\x1d.user_profile.RegisterRequest\x1a\x1e.user_profile.RegisterResponse\"\x17\x82\xd3\xe4\x93\x02\x11:\x01*\"\f/v1/register\x12V\n" +
	"\x05Login\x12\x1a.user_profile.LoginRequest\x1a\x1b.user_profile.LoginResponse\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/login\x12c\n" +
	"\fRefreshToken\x12\x1c.user_profile.RefreshRequest\x1a\x1d.user_profile.RefreshResponse\"\x16\x82\xd3\xe4\x93\x02\x10:\x01*\"\v/v1/refresh\x12T\n" +
	"\x06Logout\x12\x1b.user_profile.LogoutRequest\x1a\x16.google.protobuf.Empty\"\x15\x82\xd3\xe4\x93\x02\x0f:\x01*\"\n" +
	"/v1/logout\x12p\n" +
	"\n" +
	"GetProfile\x12\x1f.user_profile.GetProfileRequest\x1a!.user_profile.UserProfileResponse\"\x1e\x82\xd3\xe4\x93\x02\x18\x12\x16/v1/profiles/{user_id}\x12Y\n" +
	"\tListUsers\x12\x16.google.protobuf.Empty\x1a\x1e.user_profile.UserListResponse\"\x14\x82\xd3\xe4\x93\x02\x0e\x12\f/v1/profiles\x12f\n" +
	"\n" +
	"ChangeRole\x12\x1e.user_profile.AdminRoleRequest\x1a\x16.google.protobuf.Empty\" \x82\xd3\xe4\x93\x02\x1a:\x01*\x1a\x15/v1/users/change_roleB\x1bZ\x19userService.v1;uservicev1b\x06proto3"
...
var file_user_service_user_service_proto_depIdxs = []int32{
	...
	0,  // 2: user_profile.UserProfileResponse.role:type_name -> user_profile.Roles
	10, // 3: user_profile.UserListResponse.users:type_name -> user_profile.UserProfileResponse
	0,  // 4: user_profile.AdminRoleRequest.role:type_name -> user_profile.Roles
	1,  // 5: user_profile.UserService.Register:input_type -> user_profile.RegisterRequest
	3,  // 6: user_profile.UserService.Login:input_type -> user_profile.LoginRequest
	6,  // 7: user_profile.UserService.RefreshToken:input_type -> user_profile.RefreshRequest
	8,  // 8: user_profile.UserService.Logout:input_type -> user_profile.LogoutRequest
	9,  // 9: user_profile.UserService.GetProfile:input_type -> user_profile.GetProfileRequest
	13, // 10: user_profile.UserService.ListUsers:input_type -> google.protobuf.Empty
	12, // 11: user_profile.UserService.ChangeRole:input_type -> user_profile.AdminRoleRequest
	2,  // 12: user_profile.UserService.Register:output_type -> user_profile.RegisterResponse
	5,  // 13: user_profile.UserService.Login:output_type -> user_profile.LoginResponse
	7,  // 14: user_profile.UserService.RefreshToken:output_type -> user_profile.RefreshResponse
	13, // 15: user_profile.UserService.Logout:output_type -> google.protobuf.Empty
	10, // 16: user_profile.UserService.GetProfile:output_type -> user_profile.UserProfileResponse
	11, // 17: user_profile.UserService.ListUsers:output_type -> user_profile.UserListResponse
	13, // 18: user_profile.UserService.ChangeRole:output_type -> google.protobuf.Empty
